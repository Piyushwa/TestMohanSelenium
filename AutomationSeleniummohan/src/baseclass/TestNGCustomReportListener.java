...
public class TestNGCustomReportListener implements IReporter{
	  ...
	  private static final Logger LOG = Logger.getLogger(TestNGCustomReportListener.class);
		...
		private String dReportTitle = "Levels Automation Report";
	    ...
	    protected void writeReportTitle(String title) {
			writer.println("<center><h1>" + title + "-" + DriverHelper.getTimeStamp() + "</h1></center>");
		}
	    ...
	    protected void writeSuiteSummary() {
	        ...
	        for (SuiteResult suiteResult : suiteResults) {
	            ...
	            for (TestResult testResult : suiteResult.getTestResults()) {
	                ...
	                writeTableData(PropertyReader.readApplicationFile("Browser"),"num");
